...
public class MathDao {
    ...
    public MathDao(Context context) {
        mContext = context;
        String dbName = context.getExternalFilesDir(null).getPath() + "/" + AlarmState.DATABASE_NAME;
    ...
    public void insertDataFromStr(final String htmlString) {
        ...
        for (int i = 0; i < elements.size(); i++) {
            ...
            if (!sb.toString().equals("")) {
                ...
                if (mDb != null && mDb.isOpen()) {
                    ...
                    //插入数据
                    mDb.insert(AlarmState.TABLE_NAME, null, cv);
       ...
       /*     Runnable r = new Runnable() {
                ...
                public void run() {
                    try {
                        mathematic.setRightAnswer(getRightAnswer(mHttpUtil.doGet(path)));
    ...
    public Cursor queryAll() {
        ...
        Cursor c = mDb.query(AlarmState.TABLE_NAME, columns, seleciton, null, null, null, columns[0]);
        return c;
    }
