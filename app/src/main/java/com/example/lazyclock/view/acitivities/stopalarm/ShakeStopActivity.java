 ...
 */
public class ShakeStopActivity extends BaseStopActivity implements ShakeDetection.OnShakeListener {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN || keyCode == KeyEvent.KEYCODE_VOLUME_UP || keyCode == KeyEvent.KEYCODE_VOLUME_MUTE || keyCode == KeyEvent.KEYCODE_POWER) {
            //进入小睡处理
            RingtongService.stopMediaServer(ShakeStopActivity.this, mAlarmBean, 0);
            return true;
        }
            ...
            while (true) {
                ...
                while (isShake) {
                    ...
                    if (m > 10) {
                        ...
                        //关闭铃声和震动
                        util.stopAlarmRingingServer(ShakeStopActivity.this);
