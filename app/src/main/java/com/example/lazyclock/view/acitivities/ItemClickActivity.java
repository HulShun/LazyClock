    ...
    private void initEvent() {
        mEdit_Btm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setFlags(Config.AlARMTYPE_EDIT);
                startActivityForResult(intent, Config.AlARMTYPE_EDIT);
                finish();
            }
        });
        ...
        mDele_Btm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mOkBtm.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        AlarmUtil.getInstence().deleteAlarm(MyApplication.getInstance(), mAlarm);

                        dialog.cancel();
                        setResult(Config.AlARMTYPE_EDIT);
        ...
        mStopOrStart_Btm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mAlarm.isWork()) {
                    ...
                    AlarmUtil.getInstence().setAlarmToSystem(ItemClickActivity.this, mAlarm);
                }

                setResult(Config.AlARMTYPE_ONOFF);
                ItemClickActivity.this.finish();
            }
        });
    }
