...
public class AddAlarmActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getFlags() == Config.AlARMTYPE_ADD) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.addalarm_id_ok:
                ...
                intent4.setFlags(Config.AlARMTYPE_EDIT);
                intent4.putExtra("alarm", changedItemPosition);
                setResult(Config.AlARMTYPE_EDIT, intent4);
                this.finish();
                break;
            //重置按钮
            ...
            case R.id.addalarm_id_volume:
                ...
                startActivityForResult(intent1, Config.ADDALARM_TYPE_ALARMVOLUME);
                break;
            ...
            case R.id.addalarm_id_sleeptime:
                ...
                startActivityForResult(intent2, Config.ADDALARM_TYPE_MORESLEEPTIME);
                break;
            ...
            case R.id.addalarm_id_alarmstoptype:
                ...
                startActivityForResult(intent3, Config.ADDALARM_TYPE_STOPSELECT);
                break;
            //闹钟预览
            case R.id.addalarm_id_preview:
                TimeUtil.getInstance().addMillsToAlarmBean(0, mAlarmBean);
                mAlarmBean.setFlag(Config.AlARMTYPE_PREVIEW);
                AlarmUtil.getInstence().setAlarmToSystem(AddAlarmActivity.this, mAlarmBean);
                break;
        }
    }
    ...
    private boolean safeAlarm() {
        ...
        AlarmUtil alarmUtil = AlarmUtil.getInstence();
        String lastTimeStr;
        //闹钟是否重复保存
        ...
        if (mAlarmBean.getFlag() == Config.AlARMTYPE_ADD) {
            if (lists != null) {
            ...
            mAlarmBean.setFlag(Config.AlARMTYPE_EDIT);
            alarmUtil.insertAlarm(mApp, mAlarmBean);
        }

        //闹铃传给系统闹钟管理器
        alarmUtil.setAlarmToSystem(this, mAlarmBean);
