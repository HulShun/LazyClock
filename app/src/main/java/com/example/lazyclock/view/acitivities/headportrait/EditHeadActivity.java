    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.edithead_id_back:
                setResult(Config.ALARMTYPE_SETHEAD);
            ...
            case R.id.edithead_id_name:
                ...
                startActivityForResult(intent, Config.ALARMTYPE_SETHEAD);
                break;
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case Crop.REQUEST_PICK:
                if (data != null) {
                    myUser.mHeadPath = startPhotoZoom(data.getData());
                    FileUtil.getInstence().saveSetting(mApp);
                }
                break;
            //显示
