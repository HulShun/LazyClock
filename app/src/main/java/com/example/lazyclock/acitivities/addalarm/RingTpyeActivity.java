...
public class RingTpyeActivity extends Activity implements View.OnClickListener {
    ...
    private void initData() {
        ...
        if (mRing.ringType == AlarmState.RINGSELECT_RING) {
            mRingtoneNameView.setText(mRing.ringName);

        } else if (mRing.ringType == AlarmState.RINGSELECT_SILENT) {
    ...
    private void doPickRingtone() {
        ...
        startActivityForResult(intent, AlarmState.RINGSELECT_RING);
    ...
    public void onClick(View v) {
        ...
        switch (m) {
            ...
            case R.id.alertdialog_id_ok:
                ...
                //返回数据给前一个activity
                setResult(AlarmState.ADDALARM_TYPE_RINGSELECT, intent);
                finish();
                return;
            ...
            case R.id.alertdialog_id_silentbtm:
                ...
                mRing.ringType = AlarmState.RINGSELECT_SILENT;
                break;
